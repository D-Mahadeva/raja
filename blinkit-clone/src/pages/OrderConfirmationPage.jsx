// blinkit-clone/src/pages/OrderConfirmationPage.jsx
...
const OrderConfirmationPage = () => {
  ...
  const [deliveryTimer, setDeliveryTimer] = useState(10 * 60); // 10 minutes in seconds
  ...
  useEffect(() => {
    ...
    // Advance to "preparing" stage after 20 seconds
    ...
    // Advance to "on the way" stage after 40 seconds
    ...
    // Advance to "delivered" stage after 60 seconds
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-3xl mx-auto">
        <button 
          onClick={handleReturnToApp}
          className="mb-6 flex items-center text-[#0C831F] hover:underline"
        >
        ...
        <div className="bg-white rounded-lg shadow-sm border p-6 mb-6">
          <div className="flex flex-col items-center text-center mb-6">
            <div className="w-16 h-16 rounded-full bg-[#E3F3E5] flex items-center justify-center mb-4">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center p-4 bg-gray-50 rounded-lg mb-6">
            <div className="flex flex-col items-center sm:items-start mb-4 sm:mb-0">
              ...
              <div className="flex items-center">
                ...
                <button 
                  onClick={copyOrderId} 
                  className="ml-2 text-[#0C831F] hover:text-[#0A7319]"
                >
                  {copySuccess ? (
                    <CheckCircle size={16} />
                  ) : (
            ...
            <div className="relative">
              ...
              <div className="relative z-10 flex mb-6">
                <div className={`w-6 h-6 rounded-full flex items-center justify-center ${
                  deliveryStage >= 0 ? 'bg-[#0C831F] text-white' : 'bg-gray-200'
                }`}>
              ...
              <div className="relative z-10 flex mb-6">
                <div className={`w-6 h-6 rounded-full flex items-center justify-center ${
                  deliveryStage >= 1 ? 'bg-[#0C831F] text-white' : 'bg-gray-200'
                }`}>
              ...
              <div className="relative z-10 flex mb-6">
                <div className={`w-6 h-6 rounded-full flex items-center justify-center ${
                  deliveryStage >= 2 ? 'bg-[#0C831F] text-white' : 'bg-gray-200'
                }`}>
              ...
              <div className="relative z-10 flex">
                <div className={`w-6 h-6 rounded-full flex items-center justify-center ${
                  deliveryStage >= 3 ? 'bg-[#0C831F] text-white' : 'bg-gray-200'
                }`}>
          ...
          <div className="bg-[#E3F3E5] p-4 rounded-lg flex items-center mb-6">
            <div className="w-12 h-12 bg-[#0C831F] rounded-full flex items-center justify-center mr-4">
            ...
            <div>
              ...
              <div className="font-bold text-lg flex items-center">
                {deliveryStage === 3 ? (
                  <span className="text-[#0C831F]">Delivered!</span>
                ) : (
                  <>
                    <Truck className="mr-2 text-[#0C831F]" size={18} />
          ...
          <div className="mb-6">
            ...
            <div className="flex items-start p-3 border rounded-lg bg-gray-50">
              <MapPin className="text-[#0C831F] mr-2" size={18} />
        ...
        <div className="flex justify-center">
          <button 
            onClick={handleReturnToApp}
            className="px-6 py-2 bg-[#0C831F] text-white rounded-lg flex items-center"
          >
            Return to Main App
