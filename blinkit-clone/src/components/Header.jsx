    ...
    <header className="sticky top-0 w-full bg-white border-b z-10">
      <div className="container mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <Link to="/" className="flex items-center">
          <div className="mr-2 font-bold text-xl text-[#0C831F]">
            blinkit
          </div>
        </Link>
        ...
        <div className="flex items-center text-xs">
          <div className="flex items-center mr-4">
            <Clock size={14} className="mr-1 text-[#0C831F]" />
            <span>Delivered in 10 minutes</span>
          </div>
          <div className="flex items-center">
            <MapPin size={14} className="mr-1 text-[#0C831F]" />
        ...
        <div className="flex items-center space-x-4">
          <a href="tel:18002100000" className="flex items-center text-sm">
            <Phone size={16} className="mr-1 text-[#0C831F]" />
            <span>Support</span>
          </a>
          <a href="#" className="flex items-center text-sm">
            <HelpCircle size={16} className="mr-1 text-[#0C831F]" />
            <span>Help</span>
          </a>
        </div>
      </div>
